...
```HTML
<script src="https://cdn.jsdelivr.net/npm/ol-popup@latest/dist/ol-popup.js"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ol-popup@latest/dist/ol-popup.css" />
```
