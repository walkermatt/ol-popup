interface MapViewportLeaf {
	extent?: string;
	LODS?: ViewportLevelsElement;
	AreChildrenOrdered?: boolean;
}

interface ViewportLevelsElement {
	LODS?: Array<ViewportLevelOfDetailElement>;
	AreChildrenOrdered?: boolean;
}

interface ViewportLevelOfDetailElement {
	level?: number;
	resolution?: number;
	scale?: number;
	AreChildrenOrdered?: boolean;
...
interface MapSymbologyElements {
	Symbols?: Array<MonikerSymbologyElement>;
	IconWidth?: number;
	IconHeight?: number;
}

interface MonikerSymbologyElement {
	Icons?: Array<MapIconConfigElement>;
	id?: string;
	Label?: string;
	template?: string;
}

interface MapIconConfigElement {
	Filters?: MapIconFilterCollectionElement;
	id?: string;
	type?: string;
	style?: string;
	Width?: number;
...
interface MapIconFilterCollectionElement {
	Filters?: Array<MapIconFilterConfigElement>;
}

interface MapIconFilterConfigElement {
	id?: string;
	Value?: string;
}

let Symbols: MapSymbologyElements = {
    "Symbols": [
        {
            "Icons": [
                {
